...
import { SHAPES, sizeOf } from "./shapes.ts";
...
const LIST = [
  // Common · Iron
  mod("heat-coil", "Heat Coil", "common", "solar", null, "single", "A basic Heat generator.", [generate("heat", [1, 2, 3])], [out(0, "e", "heat")]),
  ...
  mod("arc-dynamo", "Arc Dynamo", "common", "arc", null, "single", "A basic Charge producer.", [generate("charge", [1, 2, 3])], [out(0, "e", "charge")]),
  mod("battery-cell", "Battery Cell", "common", "arc", null, "single", "Stores more Charge.", [capacity([2, 3, 5])], [into(0, "w", "charge")]),
  mod("void-tap", "Void Tap", "common", "void", null, "single", "Drains the opponent's energy into Void.", [leech("either", [1, 2, 3])], [out(0, "e", "void")]),
  // Uncommon · Bronze
  ...
  // Rare · Silver
  mod("furnace", "Furnace", "rare", "solar", null, "domino", "Stronger Heat generation.", [generate("heat", [2, 3, 5])], [out(1, "e", "heat")]),
  ...
  mod("chain-circuit", "Chain Circuit", "rare", "arc", "tech", "triomino-i", "Makes more Charge for every link it is part of.",
  ...
  mod("feedback-loop", "Feedback Loop", "super-rare", "arc", null, "single", "Gives Charge back whenever a linked mod spends it.",
